...
// impl<'ctx> AnyValue<'ctx> for CompiledLiteral<'ctx> {
//     fn as_any_value_enum(&self) -> inkwell::values::AnyValueEnum<'ctx> {
//         match self {
//             Self::Number(number) => number.as_any_value_enum(),
//             Self::String(string) => string.as_any_value_enum(),
//         }
//     }

//     fn print_to_string(&self) -> inkwell::support::LLVMString {
//         match self {
//             Self::Number(number) => number.print_to_string(),
//             Self::String(string) => string.print_to_string(),
//         }
//     }
// }
